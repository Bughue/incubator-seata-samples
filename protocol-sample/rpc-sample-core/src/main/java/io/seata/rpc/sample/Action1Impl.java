...
public class Action1Impl implements Action1 {
    ...
    private static Map<String, Integer> commitMap = new ConcurrentHashMap<>();
    private static Map<String, Integer> rollbackMap = new ConcurrentHashMap<>();
